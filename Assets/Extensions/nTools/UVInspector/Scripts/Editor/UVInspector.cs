...
namespace nTools.UVInspector
{
    ...
    public class UVInspector : EditorWindow
    {
        ...
        static class Styles
        {
            ...
            public static GUIStyle  warningTop;
            public static GUIStyle  warningBottom;
            ...
            static Styles()
            {
                ...
                warningTop = new GUIStyle(EditorStyles.boldLabel);
                warningTop.alignment = TextAnchor.UpperCenter;
                warningTop.normal.textColor = Color.red;
                warningTop.fontSize = warningTop.fontSize + 4;

                warningBottom = new GUIStyle(warningTop);
                warningBottom.alignment = TextAnchor.LowerCenter;
      ...
      //  RenderTextureScaler
        ...
        public class TextureSettingsPopupWindow : PopupWindowContent
        {
            ...
            public override void OnGUI(Rect rect)
            {
                ...
                inspector.m_PreviewTextureSource = (PreviewTextureSource)GUILayout.Toolbar((int)inspector.m_PreviewTextureSource,
                    Styles.previewTextureSourceNames, GUILayout.MaxWidth(200), GUILayout.Height(20));
                EditorGUILayout.EndHorizontal();
                ...
                {
                    inspector.m_CustomPreviewTexture = (Texture)EditorGUILayout.ObjectField("Image",
                        inspector.m_CustomPreviewTexture, typeof(Texture), false);
                }
        ...
        Texture                 m_CustomPreviewTexture = null;
        ColorChannels			m_PreviewTextureChannels = ColorChannels.All;

        Texture					m_PreviewTexture = null;
        ...
        void OnEnable ()
        {
            ...
            m_CustomPreviewTexture = (Texture)AssetDatabase.LoadAssetAtPath(
                EditorPrefs.GetString("nTools.UVInspector.customPreviewTexture", ""), typeof(Texture));
            m_PreviewTextureTintColor = IntToColor(EditorPrefs.GetInt("nTools.UVInspector.previewTextureTintColor",
                ColorToInt(m_PreviewTextureTintColor)));
            ...
            case EventType.Repaint:
                {
                    ...
                    switch (m_PreviewTextureSource)
                    {
                        case PreviewTextureSource.Material: texture = m_PreviewTexture;
                            break;
                        case PreviewTextureSource.Custom: texture = m_CustomPreviewTexture;
                            break;
                    }

                    // Check texture
                    bool isTextureValid = true;
                    if(texture != null)
                    {
                    ...
                    // Preview texture
                    if(texture != null && isTextureValid && m_InspectedObjects.Count > 0)
                    {
                        // is normal map ?
                        {
                            ...
                            if (texPath != null)
                            {
                                ...
                                isNormalMap = assetImporter != null &&
                                              assetImporter is TextureImporter textureImporter &&
                                              textureImporter.textureType == TextureImporterType.NormalMap;
                            }

                            SetMaterialKeyword(m_SimpleMaterial, "_NORMALMAP", isNormalMap);
                        }
                    ...
                    if(m_InspectedObjects.Count > 0 && !isTextureValid)
                        EditorGUI.LabelField(rect, new GUIContent("WARNING: unsupported texture dimension,\nonly 2D texture supported"), Styles.warningTop);
        ...
        void UpdateTexture(bool showGUI)
        {
            ...
            m_PreviewTexture = objectMaterials[currentSubmesh].GetTexture(propertyNames[preferredTexturePropertyIndex]);
            return;
        ...
        void OnGUI ()
        {
            ...
            {
                EditorGUI.LabelField(previewWindowRect, "Unassigned UV Channel", Styles.warningBottom);
            }
